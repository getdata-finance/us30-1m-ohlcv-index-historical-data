...
> **Sample on GitHub** · `US30_1m.csv` (55,440 rows, `2026-07-07` -> `2026-09-02`, 4.10 MB). **Full archive on [getdata.finance](https://getdata.finance/datasets/us30)** — **6,024,308** `1m` rows, **11 timeframes**, `2009-03-11` -> `2026-09-02`.
